            ...
            >
              <div className="px-4 pb-4 space-y-4 border-t border-neutral-900 pt-4">
                ...
                <button
                  ...
                  className="w-full mt-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-medium py-3 rounded-xl text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2 shadow-lg shadow-violet-500/20"
                >
